...
public class Diviner {
    ...
    public static int Divine(String runID, String method, BlockInfo block, String Benchmark, int iterations, Boolean lowFootPrint) {
        ...
        if (lowFootPrint) {
            RemoveVtuneRun.run(runLocationBase);
        }
        ...
        while (upperBound - lowerBound > 1) {
            ...
            if (lowFootPrint) {
                String directoryPath = "/home/hb478/repos/GTSlowdownSchedular/Data/" + runID + "_SlowDown_Data/LowFootPrintDumps";
                ...
                String outputFilePath2 = String.format("/home/hb478/repos/GTSlowdownSchedular/Data/%s/%s.txt",  runID + "_SlowDown_Data/LowFootPrintDumps/", formattedRunLocation);
            ...
            if (currentTotalCPUSpeed > baseCPUSpeed + baseTotalCpuTime) {
                upperBound = initialGuess;
            } else {
                lowerBound = initialGuess;
                upperBound = Math.max(upperBound, initialGuess + 3); // Dynamically expand upperBound if needed
            }
