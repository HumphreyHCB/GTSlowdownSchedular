...
public class DiviningRunner {
    ...
    public static void run(String Benchmark, int iterations, String RunID, Boolean lowFootPrint, boolean compilerReplay, double slowdownAmount) {
        ...
        for (String method : methods) {
            ...
            for (BlockInfo blockInfo : blocks) {
                ...
                int slowdownValue = Diviner.DivineComplex(RunID, formattedMethodName, blockInfo, Benchmark, iterations, lowFootPrint, compilerReplay, slowdownAmount);
