...
public class GodRunner {
    ...
    public static void main(String[] args) {
       ...
       // new GTSchedular("DeltaBlue", iterations, true, true, 2);
        ...
        new GTSchedular("Towers", iterations, true, true, 2, "RPP", "NONE");
        new GTSchedular("Towers", iterations, true, true, 2, "RPP", "A");
        new GTSchedular("Towers", iterations, true, true, 2, "RPP", "B");
